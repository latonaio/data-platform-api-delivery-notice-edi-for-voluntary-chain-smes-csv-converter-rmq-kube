...
import (
	dpfm_api_caller "data-platform-api-delivery-notice-edi-for-voluntary-chain-smes-csv-converter-rmq-kube/DPFM_API_Caller"
...
func callProcess(rmq *rabbitmq.RabbitmqClient, caller *dpfm_api_caller.DPFMAPICaller, reader *dpfm_api_input_reader.FileReader, f *dpfm_api_input_reader.Request) error {
	...
	case "FUNCTION_DPFM_DELIVERY_NOTICE_EDI_FOR_VOLUNTARY_CHAIN_SMES_CSV_READS":
		err = caller.DeliveryNoticeEdiForVoluntaryChainSmes(rmq, reader, f)
	default:
