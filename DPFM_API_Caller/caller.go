...
import (
	"bufio"
	"context"
	dpfm_api_input_reader "data-platform-api-delivery-notice-edi-for-voluntary-chain-smes-csv-converter-rmq-kube/DPFM_API_Input_Reader"
	dpfm_api_output_formatter "data-platform-api-delivery-notice-edi-for-voluntary-chain-smes-csv-converter-rmq-kube/DPFM_API_Output_Formatter"
	"data-platform-api-delivery-notice-edi-for-voluntary-chain-smes-csv-converter-rmq-kube/config"
	"io/ioutil"
	"os"
...
func (c *DPFMAPICaller) DeliveryNoticeEdiForVoluntaryChainSmes(rmq *rabbitmq.RabbitmqClient, reader *dpfm_api_input_reader.FileReader, f *dpfm_api_input_reader.Request) error {
...
func (c *DPFMAPICaller) setHeaderData(deliveryMessage *dpfm_api_output_formatter.DataConcatenation, f *dpfm_api_input_reader.Request, apiErr error) *dpfm_api_output_formatter.DeliverySDC {
	...
	return &dpfm_api_output_formatter.DeliverySDC{
		...
		ServiceLabel:        "FUNCTION_DELIVERY_NOTICE_EDI_FOR_VOLUNTARY_CHAIN_SMES_DATA_CONCATENATION",
		APIType:             f.APIType,
